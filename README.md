...
In the architecture, you can configure your infrastructure using the followings,
  ...
  - The Launch Template should be configured to;
    ...
    - Download the "My Phonebook Application in AWS Architecture" folder from Github repository,

    - Install the requirements using requirements.txt in 'My Phonebook Application in AWS Architecture' folder
    ...
    - Instance launched should be tagged `My-Project`
...
- Step 5: Download or clone project definition from `my-phonebook-application-in-AWS-architecture
` repo on Github 
